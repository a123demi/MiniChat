...
public class FaceConversionUtil {
	...
	/** 保存于内存中的表情集合 */
	private List<ChatEmoBean> emojis = new ArrayList<ChatEmoBean>();

	/** 表情分页的结果集合 */
	public List<List<ChatEmoBean>> emojiLists = new ArrayList<List<ChatEmoBean>>();
	 ...
	 * @return
	 */
	private List<ChatEmoBean> getData(int page) {
		...
		List<ChatEmoBean> list = new ArrayList<ChatEmoBean>();
		list.addAll(emojis.subList(startIndex, endIndex));
		if (list.size() < pageSize) {
			for (int i = list.size(); i < pageSize; i++) {
				ChatEmoBean object = new ChatEmoBean();
				list.add(object);
			}
		}
		if (list.size() == pageSize) {
